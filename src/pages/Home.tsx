...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative py-24 md:py-32 overflow-hidden bg-orange-50">
        <div className="absolute inset-0 bg-[url('https://picsum.photos/seed/himalayas/1920/1080')] bg-cover bg-center opacity-10 mix-blend-multiply" />
        <div className="container relative mx-auto px-4 text-center">
          <div className="inline-flex items-center justify-center p-3 bg-orange-100 rounded-full mb-8">
            <Flame className="h-6 w-6 text-orange-600" />
          </div>
          <h1 className="text-4xl md:text-6xl font-bold text-orange-950 mb-6 tracking-tight max-w-4xl mx-auto">
            {t('hero_title')}
          </h1>
          <p className="text-lg md:text-xl text-orange-800/80 mb-10 max-w-2xl mx-auto leading-relaxed">
            {t('hero_subtitle')}
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button size="lg" variant="outline" className="w-full sm:w-auto text-lg px-8 bg-white/50 backdrop-blur-sm" asChild>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={i} className="border-orange-100 hover:shadow-md transition-shadow">
                <CardHeader>
          ...
          <div className="text-center mt-12">
            <Button variant="ghost" className="text-orange-600" asChild>
      ...
      {/* Mission Vision */}
      <section className="py-20 bg-orange-900 text-orange-50">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          <h2 className="text-3xl font-bold text-white mb-8">{t('mission_vision')}</h2>
          <div className="space-y-6 text-lg text-orange-100/90 leading-relaxed">
